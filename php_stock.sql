...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2022 at 09:40 PM
...
INSERT INTO `tbl_sales_details` (`sale__id`, `sale_date`, `sale_branch`, `sale_customer`, `sale_invoice`, `sale_barcode`, `sale_price`, `sale_quantity`, `sale_total_price`) VALUES
(1, '2022-04-27', 9, 4, 55555, 202202, 1100, 2, 2200),
(2, '2022-04-27', 9, 4, 55555, 202203, 2800, 2, 5600);
...
CREATE TABLE `tbl_sales_summary` (
  `ss_id` int NOT NULL,
  `ss_branch` int NOT NULL,
  `ss_date` date NOT NULL,
  `ss_invoice` int NOT NULL,
  `ss_total_quantity` int NOT NULL,
  `ss_total_price` int NOT NULL,
  `ss_discount_amount` int NOT NULL,
  `ss_net_amount` int NOT NULL,
  `ss_due_amount` int NOT NULL,
  `ss_due_date` date NOT NULL,
  `ss_employe` int NOT NULL,
  `ss_customer` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `tbl_sales_details`
  MODIFY `sale__id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
